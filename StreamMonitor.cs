...
public static class StreamMonitor
{
    ...
    private static readonly TwitchAPI TwitchAPI = new(settings: new ApiSettings() { AccessToken = Config.Token, ClientId = Config.ClientID });
    private static readonly LiveStreamMonitorService Monitor = new(TwitchAPI, 10);
